...
import { ESTADO_LABELS, VALID_TRANSITIONS, ORIGEN_LABELS } from '@/lib/types';
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {hd.fecha_asignacion && (
            <div>
              ...
              <p className="font-medium text-slate-800">{new Date(hd.fecha_asignacion).toLocaleString('es-MX')}</p>
            </div>
          )}
          {hd.fecha_compromiso && (
            <div>
